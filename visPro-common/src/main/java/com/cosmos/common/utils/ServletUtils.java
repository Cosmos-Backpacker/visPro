...
import com.cosmos.common.constant.Constants;
...
public class ServletUtils {
     ...
     * @return Mono<Void>
     */
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, Object value, HttpStatus unauthorized) {
