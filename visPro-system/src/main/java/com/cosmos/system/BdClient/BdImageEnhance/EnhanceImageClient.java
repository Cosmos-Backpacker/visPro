...
public class EnhanceImageClient {
    ...
    private final BDConfig bdConfig;


    public EnhanceImageClient(BDConfig bdConfig) {
    ...
    public String styleTrans(@RequestParam(value = "file", required = false) MultipartFile file,
        ...
        // 创建一个options用于请求时设置要求
        HashMap<String, String> options = getTransformOption(choice);
    ...
    @NotNull
    private static HashMap<String, String> getTransformOption(int choice) {
